            ...
            >
              ...
              <div className="flex-1 grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch overflow-visible">
                ...
                <div className="lg:col-span-7 flex flex-col gap-6">
                  ...
                  <div className="w-full bg-white/45 border border-white/50 rounded-2xl p-5 flex flex-col sm:flex-row flex-wrap justify-between gap-4 shadow-sm">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="pl-3 border-l-2 border-[#3E4450]/25 space-y-3">
                          ...
                          <div>
                            ...
                            <p className="text-justify leading-relaxed">
                              AI giúp dựng khung bài thuyết trình rất nhanh, đỡ tốn thời gian cày tài liệu tiếng Anh để lọc ý chính. Tuy nhiên, nội dung AI đưa ra còn nông, thiếu các phương trình nhiệt động lực học và các thông số thực nghiệm chính xác. Tôi chỉ lấy dàn ý của AI làm sườn, sau đó tự tra ngược lại giáo trình và các paper khoa học uy tín để điền công thức vào, đồng thời check lại các con số vì AI đôi khi hay "ảo giác" số liệu.
                            </p>
                          </div>
                ...
                <div className="lg:col-span-5 flex flex-col justify-start lg:sticky lg:top-0 h-fit gap-6">
                  ...
                  <div className="w-full aspect-[3/4] border border-[#3E4450]/20 bg-white/20 rounded-3xl overflow-hidden shadow-md flex items-center justify-center relative group min-h-[480px]">
                    <img 
                      src={minhchunginforgraphicbai6} 
                      alt="Minh chứng Infographic Bài 6" 
