                ...
                <div className="lg:col-span-7 flex flex-col gap-6">
                  ...
                  >
                    ...
                    <p className="text-sm sm:text-base text-[#3E4450] font-semibold leading-relaxed text-justify italic border-l-2 border-[#3E4450]/30 pl-4 py-1">
                      "Là một sinh viên chuyên ngành Vật lý kỹ thuật, trước đây em thường nghĩ môn học này chỉ dừng lại ở các kỹ năng soạn thảo văn bản hay làm slide thuyết trình đơn giản. Tuy nhiên, sau khi đi qua toàn bộ lộ trình, em thực sự bất ngờ về sự thay đổi trong tư duy học tập số của bản thân. Cảm giác tự tay sắp xếp hệ thống thư mục khoa học, thiết lập bộ nguyên tắc tương tác AI học đường và tự mình xây dựng trang Portfolio cá nhân này mang lại cho em niềm vui và sự tự tin lớn. Môn học đã giúp em phá bỏ giới hạn của những công cụ văn phòng thông thường, biến chúng thành phương tiện mạnh mẽ để tối ưu hóa việc quản lý dữ liệu nghiên cứu thực nghiệm hàng ngày."
                    </p>
                  </motion.div>
                  ...
                  >
                    ...
                    <p className="text-xs sm:text-sm text-[#3E4450] font-semibold leading-relaxed text-justify">
                      Giai đoạn đầu của chương trình học giúp em chuẩn hóa toàn bộ không gian học tập số và phương pháp nghiên cứu tài liệu khoa học. Bắt đầu với <strong className="text-[#3E4450]">Bài 1</strong>, việc xây dựng cấu trúc thư mục phân cấp chuẩn và quy chuẩn đặt tên tệp logic theo định dạng kebab-case giúp em quản lý hàng trăm tài liệu thực nghiệm một cách nhanh chóng và hệ thống. Sang <strong className="text-[#3E4450]">Bài 2</strong>, việc vận dụng linh hoạt các toán tử tìm kiếm nâng cao (AND, OR, site:, filetype:) cùng bộ tiêu chuẩn CRAAP đã hỗ trợ tối đa trong việc chọn lọc, thẩm định các bài báo học thuật uy tín trên các hệ thống cơ sở dữ liệu lớn. Cuối cùng ở <strong className="text-[#3E4450]">Bài 3</strong>, nghệ thuật Prompt Engineering với các kỹ thuật Few-shot và Chain-of-Thought đã nâng tầm cách em giao tiếp với AI, biến mô hình ngôn ngữ lớn thành một trợ lý nghiên cứu đắc lực, hỗ trợ phân tích dữ liệu bán dẫn và viết báo cáo học thuật chuyên nghiệp.
                    </p>
                  </motion.div>
